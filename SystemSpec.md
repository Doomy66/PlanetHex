...
4.5 Gas giants carry moons, as a count and as names. A moon is not generated as a world in this pass, and 13.1 says why that is the first thing likely to change.
...
13.1 **Satellites as main worlds.** Traveller is full of main worlds that are moons of gas giants, and it is one of the setting's better details. Nothing here forbids it and nothing here does it: 4.5 gives a gas giant a count of moons and no more. Doing it properly means a moon has to be openable as a planet, which is section 6 applied one level deeper.
