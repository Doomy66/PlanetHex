...
2.6 **Saying something about it.** The landing page carries the release notes and a way to suggest something, with the version beside them. A user who has just arrived wants to know what the thing is; a user who has been using it for a month wants to tell somebody what it should do next.

2.6.0.1 Not the help. The help is about a planet — its panels, its map, its globe — and offering it from a page where three of the four choices are not a planet would be answering a question nobody on that page has asked yet. It stays where it applies, one level in.
